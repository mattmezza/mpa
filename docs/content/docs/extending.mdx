...
secret) or **GitHub App**. In App mode a agent can carry its **own** app (App ID +
...
freely mixed with PAT agents; a agent never borrows the owner's PAT. Optionally add an
