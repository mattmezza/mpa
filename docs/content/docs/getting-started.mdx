...
4. **Telegram** — bot token and allowed user IDs for the default agent's bot (each agent's bot is later configured per-agent on the Agents tab)
5. **WhatsApp** — optional WhatsApp tool setup
